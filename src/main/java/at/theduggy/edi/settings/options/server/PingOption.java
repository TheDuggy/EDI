...
public class PingOption extends Option {
    public PingOption(String displayName, String optionInfo, String optionIdentifierName) {
        super(displayName, optionInfo, optionIdentifierName, false);
    }

    @Override
    public String getValue(Player player) {
        String value = player.getPing() + "ms";
        return value;
    }
}
